...
Table of Contents
1. [Introduction to jQuery](#1c)
2. [Learn How Script Tags and Document Ready Work](#2c)
3. [HTML Elements with Selectors Using jQuery](#3c)
4. [Target Elements by Class Using jQuery](#4c)
5. [Target Elements by id Using jQuery](#5c)
6. [Target the Same Element with Multiple jQuery Selectors](#6c)
7. [Remove Classes from an Element with jQuery](#7c)
8. [Change the CSS of an Element Using jQuery](#8c)
9. [Disable an Element Using jQuery](#9c)
10. [Change Text Inside an Element Using jQuery](#10c)
11. [Remove an Element Using jQueryUse appendTo to Move Elements with jQuery](#12c)
13. [Clone an Element Using jQuery](#13c)
14. [Target the Parent of an Element Using jQuery](#14c)
15. [Target the Children of an Element Using jQuery](#15c)
16. [Target a Specific Child of an Element Using jQuery](#16c)
17. [Target Even Elements Using jQuery](#17c)
18. [Use jQuery to Modify the Entire Page](#18c)
...
## HTML Elements with Selectors Using jQuery
